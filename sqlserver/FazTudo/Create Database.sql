...
ALTER TABLE dbo.FP ADD CONSTRAINT FK_FP_F FOREIGN KEY (F#) REFERENCES dbo.F (F#)
GO

ALTER TABLE dbo.FP ADD CONSTRAINT FK_FP_P FOREIGN KEY (P#) REFERENCES dbo.P (P#)
GO

CREATE NONCLUSTERED INDEX IX_FP_F ON dbo.FP (F#)
GO

CREATE NONCLUSTERED INDEX IX_FP_P ON dbo.FP	(P#)
GO
